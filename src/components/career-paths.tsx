        ...
        <section id="paths" className="py-24 sm:py-32 relative overflow-hidden bg-white border-t border-slate-100">
            ...
            <div className="max-w-[1400px] mx-auto px-6 relative z-10 font-plus-jakarta">
                ...
                <div className="flex justify-center mb-12 sm:mb-20">
                    <div className="w-full max-w-2xl overflow-x-auto no-scrollbar pb-4 flex justify-start sm:justify-center px-4">
                        <div className="inline-flex p-1 sm:p-2 bg-slate-200/50 backdrop-blur-xl rounded-[1.2rem] sm:rounded-[2rem] border border-white shadow-inner min-w-max mx-auto">
                            {CATEGORIES.map((tab) => (
                                <button
                                    key={tab}
                                ...
                                >
                                    {activeTab === tab && (
                                        <motion.div
                                            ...
                                            className="absolute inset-0 bg-brand-gradient rounded-[1.2rem] sm:rounded-[1.5rem] shadow-lg shadow-udanix-blue/20"
                                ...
                                >
                                    <div className="relative h-full bg-white rounded-[2.5rem] p-6 sm:p-8 border border-slate-200/60 hover:border-udanix-blue/30 shadow-[0_20px_50px_-12px_rgba(0,0,0,0.05)] transition-all duration-500 flex flex-col hover:-translate-y-2 hover:shadow-[0_40px_80px_-15px_rgba(14,57,154,0.1)] overflow-hidden">
                                        ...
                                        <div className="flex justify-between items-start mb-6 sm:mb-8">
                                            <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-xl sm:rounded-2xl bg-slate-50 border border-slate-100 flex items-center justify-center text-udanix-blue group-hover:bg-brand-gradient group-hover:text-white group-hover:border-transparent transition-all duration-500 shadow-inner">
                                                <career.icon className="w-6 h-6 sm:w-7 sm:h-7" />
                                            </div>
                                            <span className={`px-2.5 py-1 sm:px-3 sm:py-1.5 rounded-full text-[9px] sm:text-[10px] font-black uppercase tracking-[0.1em] ${
                                        ...
                                        <h3 className="text-xl sm:text-2xl font-black text-slate-950 leading-tight mb-3 sm:mb-4 group-hover:text-udanix-blue transition-all duration-300 uppercase">
                                            {career.title}
                                        </h3>
                                        ...
                                        <div className="space-y-4 mb-6 sm:mb-8">
                                            <div className="flex items-center justify-between p-3 sm:p-4 bg-slate-50 rounded-xl sm:rounded-2xl border border-slate-100 backdrop-blur-sm">
                                                <div className="flex flex-col gap-0.5 sm:gap-1">
                                                    <span className="text-[9px] sm:text-[10px] text-slate-400 uppercase font-black tracking-wider">Salary Range</span>
                                                    <div className="flex items-center gap-1 sm:gap-1.5">
                                                        <IndianRupee className="w-3 h-3 sm:w-3.5 sm:h-3.5 text-udanix-blue" />
                                                        <span className="text-[10px] sm:text-xs font-bold text-slate-950">{career.salary}</span>
                                                    </div>
                                                </div>
                                                <div className="w-[1px] h-6 sm:h-8 bg-slate-200" />
                                                <div className="flex flex-col gap-0.5 sm:gap-1 text-right">
                                                    <span className="text-[9px] sm:text-[10px] text-slate-400 uppercase font-black tracking-wider">Growth</span>
                                                    <div className="flex items-center justify-end gap-1 sm:gap-1.5">
                                                        <TrendingUp className="w-3 h-3 sm:w-3.5 sm:h-3.5 text-emerald-600" />
                                                        <span className="text-[10px] sm:text-xs font-bold text-emerald-600">{career.growth.split(' ')[0]}</span>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div className="flex items-center justify-between px-1 sm:px-2">
                                                <div className="flex items-center gap-1.5 sm:gap-2">
                                                    ...
                                                    <span className="text-[9px] sm:text-xs text-slate-500 font-bold uppercase tracking-wider">{career.duration}</span>
                                                </div>
                                                <div className="flex items-center gap-1.5 sm:gap-2">
                                                    <Users className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-slate-400" />
                                                    <span className="text-[9px] sm:text-xs text-slate-500 font-bold uppercase tracking-wider">In-Demand</span>
                                                </div>
                                            </div>
                                        </div>
